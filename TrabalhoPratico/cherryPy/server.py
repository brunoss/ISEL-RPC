...
class HTTPServer(object):
    ...
    def start(self):
        ...
        if os.getenv('LISTEN_PID', None):
            ...
            # PTS:fix; abr.2018
            #(proximas linhas comentadas; substituidas pelas seguintes)
            #info = [
            ...
            print( "(1/3) PTS: || meu ajuste! || AF_INET or AF_INET6 socket" )
    ...
    def bind(self, family, type, proto=0):
        ...
        # PTS:fix; abr.2018
        #(proxima linha comentada; substituida pelas seguintes)
        #if family != socket.AF_UNIX:
        if not hasattr( socket, "AF_UNIX" ):
            print( "(2/3) PTS: || meu ajuste! || not hasattr( socket, \"AF_UNIX\" )" )
        ...
        print( "(3/3) PTS: || meu ajuste! || APOS >> not hasattr( socket, \"AF_UNIX\" )" )
